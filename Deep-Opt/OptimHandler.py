...
class OptimHandler(ABC):
    ...
    def assess_changes(self, solutions: torch.Tensor, fitnesses: torch.Tensor,
        ...
        new_fitnesses[active] = self.problem.fitness(new_solutions[active], check_constraints, penalty_mult)
    ...
    def hillclimb(self, solutions: torch.Tensor, fitnesses: torch.Tensor,
        ...
        while True:
            ...
            evaluations = self.assess_changes(solutions, fitnesses, new_solutions, change_tolerance,
                                              last_improve, check_constraints, penalty_mult)
    ...
    def generate_population(self, pop_size: int, check_constraints: str, penalty_mult: int) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        fitnesses = self.problem.fitness(population, check_constraints, penalty_mult)
